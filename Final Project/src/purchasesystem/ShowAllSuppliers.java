...
public class ShowAllSuppliers {
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			...
			public void run() {
				try {
					ShowAllSuppliers window = new ShowAllSuppliers();
	...
	public void initialize() {
		frame = new JFrame("Show All Suppliers");
		frame.getContentPane().setBackground(Color.LIGHT_GRAY);
		frame.setBounds(0, 0, 1100, 700);
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		frame.getContentPane().setLayout(null);

		JLabel lblNewLabel = new JLabel("DETAILS OF ALL THE SUPPLIERS:");
		...
		}, new String[] { "S_ID", "S_NAME", "CONTACT_NO", "ADDRESS" }) {
		...
		try {
			...
			Object row1[] = { "SUPPLIER ID", "SUPPLIER NAME", "CONTACT NO", "ADDRESS" };
			dtm.addRow(row1);
			while (rs.next()) {
				...
				Object row[] = { sId, sName, contactNo, address };
